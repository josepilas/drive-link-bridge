...
Projeto: `https://github.com/josepilas/drive-link-bridge`

Ponte HTTPS: `https://josepilas.github.io/drive-link-bridge/`
...
9. Não use a página principal do usuário nem outro repositório como ponte. O endpoint oficial deste projeto é exclusivamente `https://josepilas.github.io/drive-link-bridge/`.
